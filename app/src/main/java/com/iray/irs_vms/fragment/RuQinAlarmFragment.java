...
public class RuQinAlarmFragment extends Fragment {
    public static String TAG="FireAlarmFragment";
    ...
    public List<AbnormalAlarmInfo> mRuQinAlarmList=new ArrayList<AbnormalAlarmInfo>();

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.w("RuQinAlarmFragmemnt","onCreate...............");
                ...
                while(flag) {
                    if (AllAlarmFragment.mAlarmList.size() != 0) {
                        ...
                        for(int i=0;i<AllAlarmFragment.mAlarmList.size();i++){
                            if(AllAlarmFragment.mAlarmList.get(i).getEventType().equals("10003")){
                                mRuQinAlarmList.add(AllAlarmFragment.mAlarmList.get(i));
                            }
                        }
                        Message msg = new Message();
                        msg.obj =  mRuQinAlarmList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("RuQinAlarmFragmemnt","onCreateView1...............");
        View view =  inflater.inflate(R.layout.activity_ruqin_alarm_list, container, false);
        rcDeviceList = (RecyclerView)view.findViewById(R.id.rc_ruqin_alarm_list);
        Log.w("RuQinAlarmFragmemnt","onCreateView2...............");
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if (result.size() == 0) {
                Toast.makeText(getContext(), "目前没有入侵报警信息", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public RuQinAlarmFragment(){

    }
    public void onStart() {
        super.onStart();
        Log.w(TAG,"onStart------------------"+mRuQinAlarmList.size());
        Message msg = new Message();
        msg.obj = mRuQinAlarmList;
        handler.sendMessage(msg);
    }
