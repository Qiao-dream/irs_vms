...
public class StrangerAlarmFragment extends Fragment {
    public static String TAG="StrangerAlarmFragment";
    ...
    public List<AbnormalAlarmInfo> mStrangerAlarmList=new ArrayList<AbnormalAlarmInfo>();

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.w("StrangerAlarmFragmemnt","onCreate...............");
                ...
                while(flag) {
                    if (AllAlarmFragment.mAlarmList.size() != 0) {
                        ...
                        for(int i=0;i<AllAlarmFragment.mAlarmList.size();i++){
                            if(AllAlarmFragment.mAlarmList.get(i).getEventType().equals("10005")){
                                mStrangerAlarmList.add(AllAlarmFragment.mAlarmList.get(i));
                            }
                        }
                        Message msg = new Message();
                        msg.obj = mStrangerAlarmList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("StrangerAlarmFragmemnt","onCreateView1...............");
        View view =  inflater.inflate(R.layout.activity_stranger_alarm_list, container, false);
        rcDeviceList = (RecyclerView)view.findViewById(R.id.rc_stranger_alarm_list);
        Log.w("StrangerAlarmFragmemnt","onCreateView2...............");
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if (result.size() == 0) {
                Toast.makeText(getContext(), "目前没有陌生人报警信息", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public void onStart() {
        super.onStart();
        Log.w(TAG,"onStart------------------"+mStrangerAlarmList.size());
        Message msg = new Message();
        msg.obj = mStrangerAlarmList;
        handler.sendMessage(msg);
    }

    public StrangerAlarmFragment(){
