...
public class UrgentAlarmFragment extends Fragment {
    public static String TAG="UrgentAlarmFragment";
    ...
    public List<AbnormalAlarmInfo> mUrgentAlarmList=new ArrayList<AbnormalAlarmInfo>();
    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.w("UrgentAlarmFragmemnt","onCreate...............");
                ...
                while(flag) {
                    if (AllAlarmFragment.mAlarmList.size() != 0) {
                        ...
                        for(int i=0;i<AllAlarmFragment.mAlarmList.size();i++){
                            if(AllAlarmFragment.mAlarmList.get(i).getEventType().equals("10007")){
                                mUrgentAlarmList.add(AllAlarmFragment.mAlarmList.get(i));
                            }
                        }
                        Message msg = new Message();
                        msg.obj =  mUrgentAlarmList;
    ...
    public void onStart() {
        super.onStart();
        Log.w(TAG,"onStart------------------"+mUrgentAlarmList.size());
        Message msg = new Message();
        msg.obj = mUrgentAlarmList;
        handler.sendMessage(msg);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.w("UrgentAlarmFragmemnt","onCreateView1...............");
        View view =  inflater.inflate(R.layout.activity_urgent_alarm_list, container, false);
        rcDeviceList = (RecyclerView)view.findViewById(R.id.rc_urgent_alarm_list);
        Log.w("UrgentAlarmFragmemnt","onCreateView2...............");
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if (result.size() == 0) {
                Toast.makeText(getContext(), "目前没有紧急报警信息", Toast.LENGTH_SHORT).show();
            } else {
